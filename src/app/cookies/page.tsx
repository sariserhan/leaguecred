...
export default function CookiesPage() {
  return (
    <LegalPage title="Cookie Notice">
      <section><h2>Essential cookies</h2><p>LeagueCred uses essential session cookies to keep you signed in and protect authenticated actions such as submitting a Weekly Lock. These cookies are necessary for the service to work.</p></section>
