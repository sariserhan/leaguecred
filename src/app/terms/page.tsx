...
export default function TermsPage() {
  return (
    <LegalPage title="Terms of Use">
      <section><h2>Using LeagueCred</h2><p>LeagueCred lets members build a public record from one independent Weekly Lock in the football leagues they know. By using the service, you agree to use it lawfully, provide accurate account information, and protect your sign-in credentials.</p></section>
