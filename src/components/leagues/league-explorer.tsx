    ...
    <li className="grid gap-4 border-b px-4 py-5 transition-colors last:border-b-0 hover:bg-muted/60 md:grid-cols-[1fr_1.35fr_1.25fr_1.2fr_auto] md:items-center md:gap-5">
      ...
      <div className="flex justify-end gap-2 sm:flex-row md:flex-col xl:flex-row">
        {league.available !== false ? (
          <Link href={`/leagues/${league.slug}`} className="inline-flex min-h-11 items-center justify-center gap-2 border border-inverted px-4 text-sm font-semibold transition-colors hover:bg-inverted hover:text-inverted-foreground md:min-h-10">{action}<ArrowRightIcon aria-hidden="true" className="size-4" /></Link>
