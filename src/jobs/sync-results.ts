...
async function main() {
  try {
    ...
    console.info(`Result sync completed: ${results.pending} fixture(s) waiting, ${results.updated} updated, ${results.finished} finished, ${results.requestCount} request(s) across ${results.leagues} league(s).`);
